#!/usr/bin/perl
#
# Tool: Haxmobi Facebook Craker
# Author: Hirak Das

# Code date: 16 March 2017
# 
#
# Description:
# Haxmobi Facebook Craker is a password cracking tool written in perl to perform a dictionary-based attack on a specific Facebook user through HTTPS.
#
# Usage:
# perl Haxmobi-Facebook-Craker.pl login wordlist
...
#
# Demo:
# perl Haxmobi-Facebook-Craker.pl Facebooklogin@facebook.com wordlist.lst 
#
# --- Haxmobi-Facebook-Cracker Facebook password cracking tool
# --- By Hirak Das
...
print "\n+++
        ...
        #####################################################################
        #####################################################################
        # A HAXMOBI TOOL | CREATED BY HIRAK DAS | A BEST PASSWORD CRAKER    #
        #                                                                   #
        #              DONOT USE FOR ANY ILLIGEL PURPOSE                    #
        #####################################################################
        #####################################################################            

\n";
print "+++ Coded by Hirak Das\n";
print "+++ www.fb.com\n\n";
...
{
print "\n########################################################\n";
print "[+] WOW !! PassWORD Cracked => Pass is $password :D\n";
print "########################################################\n\n";
close SSL;
exit;
}
